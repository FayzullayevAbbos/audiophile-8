...
function Footer() {
  ...
  return (
    <footer className="  bg-[#101010]">
      <div className="container relative mx-auto p-10 md:px-10  text-center md:text-left text-secondary-color  gap-8 ">
        <div className="w-28 h-1 bg-[#D87D4A] absolute top-0 left-1/2 -translate-x-1/2 md:left-10 md:translate-x-0"></div>
        ...
        <div className=" text-white">
          <ul className="uppercase text-xs flex mt-8 flex-col md:flex-row gap-4 md:gap-8 tracking-widest font-bold items-center lg:justify-end">
            ...
            <li className="hover:text-[#D87D4A]">
              <Link href="/product/speakers">speakers</Link>
            </li>
            <li className="hover:text-[#D87D4A]">
              <Link href="/product/earphones">earphones</Link>
            </li>
          </ul>
        </div>
        <div className=" mt-6 opacity-[0.5] ">
          <p className="lg:w-2/4  text-white">
        ...
        <div className=" opacity-[0.5] mt-[54px]">
